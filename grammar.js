...
module.exports = grammar({
  ...
  rules: {
    ...
    predicate: $ => prec(PREC.predicate, seq( '[', field('body', $._expr), ']')), //124
    ...
    multiplicative_expr: $ => prec.left( PREC.multiplicative, 
      seq( field('lhs', $._expr), choice('*','div','idiv','mod'), field('rhs', $._expr))),
