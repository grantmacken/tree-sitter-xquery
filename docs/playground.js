...
(async () => {
  ...
  function loadState() {
    const language = localStorage.getItem("languageXQuery");
    const sourceCode = localStorage.getItem("sourceCodeXQuery");
    const query = localStorage.getItem("queryXQuery");
    const queryEnabled = localStorage.getItem("queryEnabledXQuery");
  ...
  function saveState() {
    localStorage.setItem("languageXQuery", languageSelect.value);
    localStorage.setItem("sourceCodeXQuery", codeEditor.getValue());
    saveQueryState();
  }

  function saveQueryState() {
    localStorage.setItem("queryEnabledXQuery", queryCheckbox.checked);
    localStorage.setItem("queryXQuery", queryEditor.getValue());
  }
